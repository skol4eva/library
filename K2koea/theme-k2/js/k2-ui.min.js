...
function orderPymChk() {
	//order escrow check
	var $pymChk = $('.pym_tab .aa.chkRd_box').find('input:radio');
...
function allChk(){
	var	$allChk = $('.all_chk').find('input:checkbox'),
		...
		$agrChkTrue = $agrChk.prop('checked'),
		$agrChkLeng = $('.agr_chk').find('input:checkbox').length,
		$wrap = $('.join_agree'),
		$wrap2 = $('.join_agree').find($('.agr_chk'));
	...
	// console.log($agrChk.prop('checked') === true);
	$wrap2.each(function(){
		$contentCk = $(this).find('input:checkbox').prop('checked');
